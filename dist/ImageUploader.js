...
module.exports.ImageUploader = (function() {
  ...
  ImageUploader.prototype.httpRequest = function(params) {
  ...
  ImageUploader.prototype.requestPost = function(params, blobs, url, call, callArgs) {
    var blob, err, error, j, k, len, len1, p, query;
    query = {
      method: "POST",
      url: url,
      onload: function(res) {
  ...
  ImageUploader.prototype.dataURLtoBlob = function(cId, dataURL) {
  ...
  ImageUploader.prototype.processImage = function(iId, cId, canvas, name, image) {
  ...
  ImageUploader.prototype.resizeImage = function(cId, img, canvas, ctx) {
  ...
  ImageUploader.prototype.uploadImage = function(iId, cId, name, blob) {
  ...
  ImageUploader.prototype.updateStatus = function(iId, cId, res) {
    this.counter++;
  ...
  ImageUploader.prototype.configure = function(cfg) {
    var c, j, len, results;
    results = [];
  ...
  ImageUploader.prototype.initStatus = function() {
  ...
  ImageUploader.prototype.main = function() {
