...
module.exports.TableOfContents = /*#__PURE__*/function () {
...
EnhancedHeading = function () {
  ...
  var EnhancedHeading = /*#__PURE__*/_createClass(function EnhancedHeading(section) {
    ...
    header.css('display', 'inline-block').after($('<span>').addClass('actions').append($('<a>').css('margin-left', '4px').attr('href', '#' + header.attr('id')).text('¶')).append($('<a>').css('margin-left', '4px').attr('href', '#').text('top')).append($('<a>').css('margin-left', '4px').attr('href', '#').text('collapse').click(_collapse_section)).hide());
  });
