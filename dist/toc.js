...
module.exports.TableOfContents = class TableOfContents {
  constructor() {
...
EnhancedHeading = (function() {
  var collapse_section, expand_section, hide_actions, show_actions;
  ...
  class EnhancedHeading {
    constructor(section) {
      ...
      header.css('display', 'inline-block').after($('<span>').addClass('actions').append($('<a>').css('margin-left', '4px').attr('href', '#' + header.attr('id')).text('¶')).append($('<a>').css('margin-left', '4px').attr('href', '#').text('top')).append($('<a>').css('margin-left', '4px').attr('href', '#').text('collapse').click(collapse_section)).hide());
    }
  ...
  hide_actions = function(event) {
    return $(this).children('span.actions').hide();
  };

  collapse_section = function(event) {
    $(this).closest('div.section-start').nextAll().hide();
    $(this).text('expand').off('click', collapse_section).on('click', expand_section);
    return false;
  };

  expand_section = function(event) {
    $(this).closest('div.section-start').nextAll().show();
    $(this).text('collapse').off('click', expand_section).on('click', collapse_section);
    return false;
  };
