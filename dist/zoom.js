...
module.exports = function (img, mag, frameW, frameC, minMarg, scrBar) {
  var rappLati, rappLatiWin, winHeight, winWidth, zimg; // Controlla che l'elemento esista e sia un <img>

  if (img && img.tagName === 'IMG') {
    // Crea il nuovo elemento <img>
    zimg = document.createElement('img'); // Assegna gli attributi
    ...
    rappLati = zimg.width / zimg.height; // Ridimensionamento basato sulla larghezza
